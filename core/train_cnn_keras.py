...
class Trainner:
    ...
    image_x, image_y = _get_image_size()

    def cnn_model(self, input_shape_x: int, input_shape_y:int, plot_result: bool):
    ...
    def train(self):
        ...
        model.fit(train_images, train_labels, validation_data=(test_images, test_labels), epochs=15, batch_size=100,
