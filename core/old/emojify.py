...
from core.old.preprocess_img import create_mask, get_bounding_rect
from core.old.blend import blend
from configuration.config import current_config

CNN_MODEL = current_config.ROTEM
SHAPE_PREDICTOR_68 = current_config.ROTEM2
